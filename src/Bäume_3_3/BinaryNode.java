...
public class BinaryNode {
    ...
    // System.out.print()
    public void preorderPrint(BinaryNode root) {
        BinaryNode aktuell = root; 
        
        if (aktuell != null){
            System.out.print(root.getKey());
                if (aktuell.getLeft() != null){
                    System.out.print(aktuell.getLeft().getKey());
                    aktuell = aktuell.getLeft();
                }
                else{
                    System.out.print(aktuell.getRight().getKey());
                }
